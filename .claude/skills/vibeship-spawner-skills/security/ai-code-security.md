...
> Security vulnerabilities in AI-generated code and LLM applications, covering OWASP Top 10 for LLMs, secure coding patterns, and AI-specific threat models

**Category:** security | **Version:** 1.0.0

**Tags:** security, ai, llm, owasp, code-review, vulnerabilities
...
### [HIGH] LLM generates calls to non-existent APIs or deprecated methods
...
### [CRITICAL] LLM generates SQL with string concatenation instead of parameterization
...
### [CRITICAL] LLM includes API keys, passwords, or tokens in generated code
...
### [HIGH] LLM generates frontend code vulnerable to XSS attacks
...
### [HIGH] AI-generated agent code requests more permissions than needed
...
|---------|-------------|--------|
| `prompt injection|jailbreak` | prompt-injection-defense | Need specialized prompt injection defense |
| `security audit|penetration test|pentest` | llm-security-audit | Need comprehensive security assessment |
| `mcp tool security|tool permissions` | mcp-security | Need MCP-specific security patterns |

### Receives Work From

- **code-review**: AI-generated code needs security review
- **mcp-server-development**: MCP tools generate code that needs security validation
- **llm-game-development**: Game AI generates content needing security checks
...
Full skill path: `~/.spawner/skills/security/ai-code-security/`
