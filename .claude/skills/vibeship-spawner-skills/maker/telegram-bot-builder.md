...
**Why it's bad:** Telegram has timeout limits.
...
**Why it's bad:** Users get no response.
Bot appears broken.
Debugging nightmare.
Lost trust.
...
**Why it's bad:** Users block the bot.
Telegram may ban.
Annoying experience.
Low retention.
...
- **backend**: Backend services for bot
- **ai-wrapper-product**: AI features for bot
...
Full skill path: `~/.spawner/skills/maker/telegram-bot-builder/`
