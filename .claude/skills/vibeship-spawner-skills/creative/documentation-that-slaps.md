...
> Expert in writing documentation that developers actually read. Covers
README craft, API docs, tutorials, and internal docs. Understands that
docs are a product—they need UX, marketing, and user empathy.
...
**Why it's bad:** Can't find anything.
...
**Why it's bad:** Wrong docs worse than no docs.
Erodes trust.
Wastes time.
...
|---------|-------------|--------|
| `ship|launch|mvp` | side-project-shipping | Need shipping strategy |
| `legacy|old code|archaeology` | legacy-archaeology | Need to understand system |
| `code review|pr|feedback` | code-review-diplomacy | Need review approach |

### Receives Work From

- **side-project-shipping**: Minimal docs for shipping
- **legacy-archaeology**: Documenting discovered knowledge
- **code-review-diplomacy**: Documentation feedback
...
Full skill path: `~/.spawner/skills/creative/documentation-that-slaps/`
