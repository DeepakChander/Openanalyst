...
### [CRITICAL] Environment variables not synced to Trigger.dev cloud
...
- **backend**: Backend needs background job processing
- **ai-agents-architect**: AI workflows need long-running execution
- **nextjs-app-router**: Next.js app needs background processing
- **email-systems**: Email needs async sending
- **stripe-integration**: Payment webhooks need processing
...
Full skill path: `~/.spawner/skills/integrations/trigger-dev/`
