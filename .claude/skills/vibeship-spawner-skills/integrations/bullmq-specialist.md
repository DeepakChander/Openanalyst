...
- **email-systems**: Email needs reliable delivery via queue
- **ai-workflow-automation**: AI workflows need job orchestration
- **nextjs-app-router**: Next.js needs background processing
- **performance-hunter**: Performance needs async offloading
...
Full skill path: `~/.spawner/skills/integrations/bullmq-specialist/`
