...
- **nextjs-app-router**: Next.js needs async processing
- **ai-agents-architect**: AI workflows need reliable execution
- **email-systems**: Email needs reliable delivery
- **stripe-integration**: Payments need webhook handling
...
Full skill path: `~/.spawner/skills/integrations/inngest/`
