...
|---------|-------------|--------|
| `` | quantitative-research | Provide execution data for research |
| `` | risk-management-trading | Execution complete, apply risk management |
| `` | technical-analysis | Need technical levels for execution |
| `` | sentiment-analysis-trading | Assess market conditions for timing |
...
Full skill path: `~/.spawner/skills/trading/execution-algorithms/`
