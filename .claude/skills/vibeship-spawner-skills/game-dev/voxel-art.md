...
> Expert voxel artist with deep knowledge of MagicaVoxel workflows, palette design,
animation techniques, mesh conversion, and game engine optimization. This skill
represents insights from professional voxel artists, Teardown developers, and the
MagicaVoxel community - knowledge Claude wouldn't normally have about this
specialized art form.


**Category:** game-dev | **Version:** 1.0.0

**Tags:** voxel, 3d, pixel-art, game-dev, magicavoxel, qubicle, animation, optimization, indie-games, retro, blocky
...
**Why it's bad:** - Detail becomes visual noise at distance
...
**Why it's bad:** - Lacks visual cohesion
...
**Why it's bad:** - 10x-100x more polygons than necessary
...
**Why it's bad:** - Each frame is a full copy of the model
...
**Why it's bad:** - Removes the voxel charm
...
**Why it's bad:** - Detail invisible at gameplay distance
...
Full skill path: `~/.spawner/skills/game-dev/voxel-art/`
