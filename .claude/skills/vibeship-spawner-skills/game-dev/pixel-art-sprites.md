...
**Tags:** pixel-art, sprites, animation, game-art, retro, indie-games, 2d-graphics, sprite-sheets
...
**Why it's bad:** Creates ugly halos when used on different backgrounds
...
**Why it's bad:** Breaks visual cohesion, looks like asset flip
...
**Why it's bad:** Can make animation mushy, increases work exponentially
**Instead:** Focus on key poses. 4 great frames > 12 mediocre frames

### Ignoring Silhouette
Focusing on internal detail before silhouette works
**Why it's bad:** Character won't read against varied backgrounds
...
|---------|-------------|--------|
| `` | threejs-3d-graphics | Moving beyond 2D pixel art |
| `` | procedural-generation | Need algorithmic generation |
| `` | game-design | Need gameplay integration |
| `` | roblox-development | Roblox platform integration |
| `` | generative-art | Generative pixel art collection |
...
Full skill path: `~/.spawner/skills/game-dev/pixel-art-sprites/`
