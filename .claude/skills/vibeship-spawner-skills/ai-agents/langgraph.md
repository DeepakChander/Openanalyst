...
**Tags:** langgraph, langchain, agents, state-machine, workflow, graph, ai-agents, orchestration
...
**Why it's bad:** Agent loops forever.
...
**Why it's bad:** Loses LangGraph's benefits.
State not persisted.
...
**Why it's bad:** Hard to reason about.
...
**Why it's bad:** Can't resume on failure.
...
- **crewai**: Converting CrewAI to LangGraph
- **langfuse**: Adding observability
- **structured-output**: Agent needs structured responses
...
Full skill path: `~/.spawner/skills/ai-agents/langgraph/`
