...
**Tags:** voice-ai, speech-to-text, text-to-speech, realtime, openai-realtime, vapi, deepgram, elevenlabs, livekit, webrtc
...
**Why it's bad:** Adds seconds of latency.
...
**Why it's bad:** Frustrating user experience.
...
**Why it's bad:** May not be best quality.
...
**Why it's bad:** Too sensitive = interrupts on noise.
...
- **langgraph**: Voice agent with complex logic
- **structured-output**: Extract data from voice
- **autonomous-agents**: Voice-enabled autonomous agent
...
Full skill path: `~/.spawner/skills/ai-agents/voice-ai-development/`
