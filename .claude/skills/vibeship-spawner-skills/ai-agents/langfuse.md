...
**Tags:** langfuse, observability, tracing, llm-monitoring, evaluation, prompt-management, debugging, analytics
...
**Why it's bad:** Traces are batched.
...
**Why it's bad:** Can't debug specific users.
...
**Why it's bad:** Can see what happened, not quality.
No feedback loop.
...
- **langgraph**: Monitoring LangGraph agents
- **crewai**: Monitoring CrewAI workflows
- **structured-output**: Monitoring extraction quality
- **voice-ai-development**: Monitoring voice agents
...
Full skill path: `~/.spawner/skills/ai-agents/langfuse/`
