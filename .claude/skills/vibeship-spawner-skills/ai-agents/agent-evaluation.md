...
**Tags:** testing, evaluation, benchmark, agents, reliability, quality
...
### [HIGH] Agent scores well on benchmarks but fails in production
...
### [HIGH] Same test passes sometimes, fails other times
...
### [MEDIUM] Agent optimized for metric, not actual task
...
### [CRITICAL] Test data accidentally used in training or prompts
...
- **autonomous-agents**: Agent needs testing
- **multi-agent-orchestration**: Multi-agent system needs evaluation
- **agent-communication**: Communication layer needs testing
...
Full skill path: `~/.spawner/skills/ai-agents/agent-evaluation/`
