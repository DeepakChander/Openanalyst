...
> Tailwind CSS changed how we write styles. Instead of naming things and writing

**Category:** design | **Version:** 1.0.0

**Tags:** tailwind, css, styling, responsive, dark-mode, design-system, utility-first
...
### [CRITICAL] Dynamic class names get purged from production build

**Situation:** You build class names dynamically: `text-${color}-500`. Works in dev.
...
### [HIGH] Class order matters for conflicting utilities

**Situation:** You have `p-4 p-2` or pass className to override padding. Sometimes
...
### [HIGH] Content paths missing classes from your files

**Situation:** You add Tailwind classes to a new file or directory. They don't work.
...
### [MEDIUM] Dark mode not working with class strategy

**Situation:** You add dark: classes but they don't change anything. You toggle
...
### [MEDIUM] Using arbitrary values creates design inconsistency

**Situation:** You use p-[17px], mt-[23px], text-[15px] throughout your app. Each
...
### [MEDIUM] Hover states stuck on touch devices

**Situation:** User taps a button on mobile. The hover state applies and stays.
...
### [MEDIUM] Z-index conflicts with arbitrary values

**Situation:** You set z-[9999] to make a modal appear above everything. Then you
...
|---------|-------------|--------|
| `user needs component logic` | react-patterns | Component behavior, not styling |
| `user needs accessibility audit` | accessibility | WCAG compliance, screen reader testing |
| `user needs design system` | ui-design | Design tokens, component specifications |
| `user needs animations` | frontend-design | Complex animations beyond Tailwind |
...
Full skill path: `~/.spawner/skills/design/tailwind-css/`
