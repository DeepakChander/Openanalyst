    ...
    return (
        <section id="hero-section" ref={heroRef} className="relative overflow-hidden min-h-screen flex items-center" style={{
          ...
          <div ref={innerRef} className="absolute inset-0 flex items-center" style={{ willChange: 'transform', transformOrigin: 'center top' }}>
            ...
            <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 hidden md:block" style={{ left: '10%', width: 1, background: 'linear-gradient(to bottom, rgba(255,107,0,0.25) 0%, rgba(255,107,0,0.5) 50%, transparent 100%)' }} />
            <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 hidden md:block" style={{ left: '25%', width: 1, background: 'linear-gradient(to bottom, rgba(255,107,0,0.15) 0%, rgba(255,107,0,0.25) 50%, transparent 100%)' }} />
            <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 hidden md:block" style={{ right: '25%', width: 1, background: 'linear-gradient(to bottom, rgba(139,92,246,0.15) 0%, rgba(139,92,246,0.25) 50%, transparent 100%)' }} />
            <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 hidden md:block" style={{ right: '10%', width: 1, background: 'linear-gradient(to bottom, rgba(139,92,246,0.25) 0%, rgba(139,92,246,0.5) 50%, transparent 100%)' }} />

            {/* Horizontal accent line — hidden on mobile */}
            <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 hidden md:block" style={{ top: '38%', height: 1, background: 'linear-gradient(to right, transparent 0%, rgba(255,107,0,0.3) 30%, rgba(139,92,246,0.3) 70%, transparent 100%)' }} />
